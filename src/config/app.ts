...
export const APP_CONFIG = {
  ...
  assets: {
    ...
    productCover: new URL("../../public/assets/brand/taptopick-cover-0911-01.webp", import.meta.url).href,
    productLogo: new URL("../../public/assets/brand/TAPtoTEST-logo-0911-01.webp", import.meta.url).href,
